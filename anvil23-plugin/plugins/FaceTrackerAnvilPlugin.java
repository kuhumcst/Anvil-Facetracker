//package de.anvilsoft.plugin; // This was prepended by Michael Kipp
...
//import de.anvilsoft.Tool;
// File does not compile under Windows if "package de.anvilsoft.plugin;" is at the start and if "import de.anvilsoft.plugin.Plugin;" is absent.
...
AnvilChangeListener, AnnotationChangeListener, MouseListener
    ...
    //private JButton buttSelectTrack = new JButton("Select Track");
    ...
    public FaceTrackerAnvilPlugin()
        ...
        //typabiggest.setLineTransparency(0.8f);
    ...
    */
    ...
    public void elementChanged(AnnotationFile annotation, AnnContainer container, AnnElement element, java.lang.String action)
        {
        }
    ...
    */
    public void mediaTimeChanged(MediaTimeChangeEvent e)
        ...
        if (!disableFaceTracking) 
            ...
            BufferedImage image = new BufferedImage(horOffsetOverlayPanel + hormaxClip, verOffsetOverlayPanel + vermaxClip, BufferedImage.TYPE_INT_RGB);
            ...
            try 
                ...
                BufferedImage subimage = image.getSubimage(horOffsetOverlayPanel + horminClip, verOffsetOverlayPanel + verminClip, horSizeClip, verSizeClip);
				IplImage grabbedImage = IplImage.createFrom(subimage);
				BufferedImage grabbedBufferedImage = grabbedImage.getBufferedImage();
                headsize = horSizeClip + verSizeClip;
                setVectorSizePerUnitOfHeadSize();

				IplImage grayImage = IplImage.create(horSizeClip, verSizeClip, IPL_DEPTH_8U, 1);
/*
				BufferedImage grayBufferedImage = grayImage.getBufferedImage();
                ...
                try 
                    {
                    File outputfile = new File("subsaved.png");
                ...
                try 
                    {
                    File outputfile = new File("grabbedsaved.png");

                    ImageIO.write(grabbedBufferedImage, "png", outputfile);
                    }
                catch (IOException ee) 
                    {
                    System.out.println("Cannot write");
                ...
                try 
                    {
                    File outputfile = new File("graysaved.png");

                    ImageIO.write(grayBufferedImage, "png", outputfile);
                    }
                catch (IOException ee) 
                    {
                    System.out.println("Cannot write");
...
*/              
                ...
                */
                /*
                Copies a region of pixels from an image to the current
                ...
                */
                ...
                /* Alternative:
                java.awt.Point path[] = new java.awt.Point[5];
                path[0] = p0;
                path[1] = p1;
                path[2] = p2;
                path[3] = p3;
                ...
                */
                ...
                if (faces.total() == 0) 
                    ...
                    for (int faceIndex = 0; faceIndex < faces.total(); faceIndex++) 
                        {
						CvRect rrr = new CvRect(cvGetSeqElem(faces, faceIndex));
